...
#                         )]
#                         self.data.append([x, y] + landmarks)

#         cv2.setMouseCallback("Fullscreen", mouse_callback)
...
#             if current_time - last_capture_time >= 0.2:  # Collect data every 0.2 seconds
#                 frame_rgb = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
#                 results = self.face_mesh.process(frame_rgb)
...
#                             face_landmarks.landmark[idx].z
#                         )]
#                         self.data.append([current_time] + landmarks)
